      ...
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
        ...
        <div className="flex items-center space-x-3 md:order-2 md:space-x-3 rtl:space-x-reverse">
          <button
            href="example.com"
            type="button"
            class="focus:outline-none text-white bg-white-700 hover:bg-white-800 focus:ring-4 focus:ring-white-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-white-700 dark:focus:ring-white-900"
          >
            Login
          </button>
